...
export default function Popups({setIsRegister, setisLoading, setIsSignIn,isLoading,isRegister,isSignIn,isNotification, setIsNotification,isVault, setIsVault,isStat, setIsStat,isRecent, setIsRecent, vip, setVip, wallet,setIsWallet, isLogOut, setIsLogOut}) {
